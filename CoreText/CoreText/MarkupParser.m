...
static CGFloat ascentCallback( void *ref ){
    CGFloat height = [(NSString*)[(__bridge NSDictionary*)ref objectForKey:@"height"] floatValue];
    if (height > 100) {
        height = 100;
    }
    return height;
...
static CGFloat widthCallback( void* ref ){
    CGFloat width = [(NSString*)[(__bridge NSDictionary*)ref objectForKey:@"width"] floatValue];
    if (width > 100.0) {
        width = 100.0;
    }
    return width;
